...
public class TestMatrixPublic {
	...
	public void testa7() throws Exception {
		...
		//should work when kills are adjusted
		//passed
	}
	...
	public void testb3() throws Exception {
		...
		//String solution = "kill,down,down,fly,down,left,kill,left,kill,left,left,takePill,right,up,right,right,up,up,kill,left,left,left,down,carry,up,right,right,kill,right,right,down,fly,down,drop;5;8;1254";
		solution = solution.replace(" ", "");
		System.out.println(solution);
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
		//passed
